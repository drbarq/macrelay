...
fn cases() -> Vec<ToolCase> {
    ...
    vec![
        // ---------------- permissions ----------------
        ToolCase {
            name: "system_permissions_status",
            args: no_args,
            expect: Success,
        ...
        // ---------------- location ----------------
        ToolCase {
            name: "navigation_location_get_current",
            args: no_args,
            expect: Tolerate,
        ...
        ToolCase {
            name: "productivity_notes_list_accounts",
            args: no_args,
            expect: Success,
            note: "read-only; covered deeply by notes_integration",
        },
        ToolCase {
            name: "productivity_notes_list_folders",
            args: no_args,
            expect: Success,
            note: "read-only",
        },
        ToolCase {
            name: "productivity_notes_search_notes",
            args: dummy_query,
            expect: Success,
            note: "read-only, empty result acceptable",
        },
        ToolCase {
            name: "productivity_notes_read_note",
            args: || json!({ "name": "macrelay-smoke-nonexistent-note" }),
            expect: Tolerate,
            note: "graceful not-found expected",
        },
        ToolCase {
            name: "productivity_notes_write_note",
            args: no_args,
            expect: Skip,
            note: "mutation - covered by notes_integration",
        },
        ToolCase {
            name: "productivity_notes_delete_note",
            args: no_args,
            expect: Skip,
            note: "mutation - covered by notes_integration",
        },
        ToolCase {
            name: "productivity_notes_restore_note",
            args: no_args,
            expect: Skip,
            note: "mutation - covered by notes_integration",
        },
        ToolCase {
            name: "productivity_notes_open_note",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- mail ----------------
        ToolCase {
            name: "communication_mail_list_accounts",
            args: no_args,
            expect: Success,
            note: "read-only",
        },
        ToolCase {
            name: "communication_mail_list_mailboxes",
            args: || json!({ "account": "macrelay-smoke-nonexistent-account" }),
            expect: Tolerate,
            note: "requires account arg; dummy is fine for graceful error",
        },
        ToolCase {
            name: "communication_mail_search_messages",
            args: dummy_query,
            expect: Tolerate,
            note: "read-only but may prompt first-run Mail permission",
        },
        ToolCase {
            name: "communication_mail_get_messages",
            args: || json!({ "subject": "macrelay-smoke-nonexistent-subject" }),
            expect: Tolerate,
            note: "read-only, no match expected",
        },
        ToolCase {
            name: "communication_mail_get_thread",
            args: || json!({ "subject": "macrelay-smoke-nonexistent-subject" }),
            expect: Tolerate,
            note: "read-only, no match expected",
        },
        ToolCase {
            name: "communication_mail_compose_message",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2 via save_as_draft",
        },
        ToolCase {
            name: "communication_mail_reply_message",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "communication_mail_forward_message",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "communication_mail_update_read_state",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "communication_mail_move_message",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "communication_mail_delete_message",
            args: no_args,
            expect: Skip,
            note: "destructive - Tier 2",
        },
        ToolCase {
            name: "communication_mail_open_message",
            args: no_args,
            expect: Skip,
            note: "opens Mail.app - visible side effect",
        },
        ToolCase {
            name: "communication_mail_get_attachment",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- calendar ----------------
        ToolCase {
            name: "pim_calendar_list_calendars",
            args: no_args,
            expect: Success,
            note: "read-only",
        },
        ToolCase {
            name: "pim_calendar_search_events",
            args: dummy_query,
            expect: Tolerate,
            note: "read-only; range defaults may apply",
        },
        ToolCase {
            name: "pim_calendar_find_available_times",
            args: || {
                json!({
        ...
        ToolCase {
            name: "pim_calendar_reschedule_event",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "pim_calendar_cancel_event",
            args: no_args,
            expect: Skip,
            note: "destructive - Tier 2",
        },
        ToolCase {
            name: "pim_calendar_update_event",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "pim_calendar_open_event",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- reminders ----------------
        ToolCase {
            name: "pim_reminders_list_lists",
            args: no_args,
            expect: Success,
            note: "read-only",
        },
        ToolCase {
            name: "pim_reminders_search_reminders",
            args: dummy_query,
            expect: Tolerate,
            note: "read-only",
        },
        ToolCase {
            name: "pim_reminders_create_reminder",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "pim_reminders_complete_reminder",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "pim_reminders_update_reminder",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "pim_reminders_delete_reminder",
            args: no_args,
            expect: Skip,
            note: "destructive - Tier 2",
        },
        ToolCase {
            name: "pim_reminders_open_reminder",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- messages ----------------
        ToolCase {
            name: "communication_messages_search_chats",
            args: dummy_query,
            expect: Tolerate,
            note: "read-only SQLite path",
        },
        ToolCase {
            name: "communication_messages_get_chat",
            args: || json!({ "chat_id": -999_999_999i64 }),
            expect: Tolerate,
            note: "read-only SQLite path, non-existent ROWID",
        },
        ToolCase {
            name: "communication_messages_search_messages",
            args: dummy_query,
            expect: Tolerate,
            note: "read-only SQLite path",
        },
        ToolCase {
            name: "communication_messages_send_message",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- stickies ----------------
        ToolCase {
            name: "productivity_stickies_list",
            args: no_args,
            expect: Success,
            note: "read-only filesystem scan",
        },
        ToolCase {
            name: "productivity_stickies_read",
            args: || json!({ "sticky_id": "macrelay-smoke-nonexistent-sticky" }),
            expect: Tolerate,
            note: "read-only, graceful not-found expected",
        },
        ToolCase {
            name: "productivity_stickies_create",
            args: no_args,
            expect: Skip,
            note: "mutation - Tier 2",
        },
        ToolCase {
            name: "productivity_stickies_open",
            args: no_args,
            expect: Skip,
        ...
        // ---------------- shortcuts ----------------
        ToolCase {
            name: "productivity_shortcuts_list",
            args: no_args,
            expect: Success,
            note: "read-only CLI call",
        },
        ToolCase {
            name: "productivity_shortcuts_get",
            args: || json!({ "name": "macrelay-smoke-nonexistent-shortcut" }),
            expect: Tolerate,
            note: "graceful not-found expected",
        },
        ToolCase {
            name: "productivity_shortcuts_run",
            args: no_args,
            expect: Skip,
        ...
        ToolCase {
            name: "navigation_map_search_places",
            args: no_args,
            expect: Skip,
            note: "opens Maps.app - visible side effect",
        },
        ToolCase {
            name: "navigation_map_get_directions",
            args: no_args,
            expect: Skip,
            note: "opens Maps.app",
        },
        ToolCase {
            name: "navigation_map_explore_places",
            args: no_args,
            expect: Skip,
            note: "opens Maps.app",
        },
        ToolCase {
            name: "navigation_map_calculate_eta",
            args: no_args,
            expect: Skip,
            note: "opens Maps.app",
        },
        // ---------------- ui_viewer ----------------
        ToolCase {
            name: "ui_ui_viewer_list_apps",
            args: no_args,
            expect: Success,
            note: "read-only process list",
        },
        ToolCase {
            name: "ui_ui_viewer_get_frontmost",
            args: no_args,
            expect: Success,
            note: "read-only",
        },
        ToolCase {
            name: "ui_ui_viewer_get_ui_tree",
            args: || json!({ "app_name": "Finder" }),
            expect: Tolerate,
            note: "Finder is always running",
        },
        ToolCase {
            name: "ui_ui_viewer_get_visible_text",
            args: || json!({ "app_name": "Finder" }),
            expect: Tolerate,
            note: "Finder is always running",
        },
        ToolCase {
            name: "ui_ui_viewer_find_elements",
            args: || json!({ "app_name": "Finder", "role": "AXButton" }),
            expect: Tolerate,
            note: "Finder is always running",
        },
        ToolCase {
            name: "ui_ui_viewer_capture_snapshot",
            args: || json!({ "app_name": "Finder" }),
            expect: Tolerate,
            note: "Finder is always running",
        },
        ...
        ToolCase {
            name: "ui_ui_controller_click",
            args: no_args,
            expect: Skip,
            note: "mouse input - needs target state",
        },
        ToolCase {
            name: "ui_ui_controller_type_text",
            args: no_args,
            expect: Skip,
            note: "keyboard input - needs target state",
        },
        ToolCase {
            name: "ui_ui_controller_press_key",
            args: no_args,
            expect: Skip,
            note: "keyboard input",
        },
        ToolCase {
            name: "ui_ui_controller_scroll",
            args: no_args,
            expect: Skip,
            note: "mouse input",
        },
        ToolCase {
            name: "ui_ui_controller_drag",
            args: no_args,
            expect: Skip,
            note: "mouse input",
        },
        ToolCase {
            name: "ui_ui_controller_select_menu",
            args: no_args,
            expect: Skip,
            note: "menu activation",
        },
        ToolCase {
            name: "ui_ui_controller_manage_window",
            args: no_args,
            expect: Skip,
            note: "window state mutation",
        },
        ToolCase {
            name: "ui_ui_controller_manage_app",
            args: no_args,
            expect: Skip,
            note: "app lifecycle mutation",
        },
        ToolCase {
            name: "ui_ui_controller_file_dialog",
            args: no_args,
            expect: Skip,
            note: "interacts with modal dialogs",
        },
        ToolCase {
            name: "ui_ui_controller_dock",
            args: no_args,
            expect: Skip,
